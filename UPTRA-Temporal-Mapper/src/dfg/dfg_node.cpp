...
//   DFGNode functions
// ===================================================
//@UPTRA: Input and Output have no operation latency 
...
void DFGNode::setLSOperation(std::string operation){ 
    // TODO: add bitwidth check
    _operation = operation; 
    setOpLatency(Operations::latency(operation));           //new
    setCommutative(Operations::isCommutative(operation));   //new
}
